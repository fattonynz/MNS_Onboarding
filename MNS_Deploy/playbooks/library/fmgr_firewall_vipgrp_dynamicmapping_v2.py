...
DOCUMENTATION = '''
---
module: fmgr_firewall_vipgrp_dynamicmapping_v2
...
options:
    ...
    vipgrp:
        ...
        type: str
        required: true
    firewall_vipgrp_dynamicmapping_v2:
 ...
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the dynamic mappings of IPv4 virtual IP groups
      fmgr_fact:
        facts:
            selector: 'firewall_vipgrp_dynamicmapping_v2'
            params:
                adom: 'ansible'
 ...
 - hosts: fortimanager00
   ...
   tasks:
    - name: Configure dynamic mappings of IPv4 virtual IP groups
      fmgr_firewall_vipgrp_dynamicmapping_v2:
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_vipgrp_dynamicmapping_v2'),
