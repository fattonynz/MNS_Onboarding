...
DOCUMENTATION = '''
---
module: fmgr_pkg_firewall_policy_v2
 ...
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the IPv4 policies
      fmgr_fact:
        facts:
            selector: 'pkg_firewall_policy_v2'
            params:
                adom: 'ansible'
                pkg: 'ansible' # package name
                policy: ''
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'pkg_firewall_policy_v2'),
