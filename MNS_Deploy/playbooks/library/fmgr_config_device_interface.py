...
DOCUMENTATION = '''
---
module: fmgr_config_device_interface
short_description: Fortimanager Fortigate Device Interface Options
description:
...
version_added: "2.0.0"
author:
    - Sachin Disanayaka @ sachin.disanayakapedige@spark.co.nz
...
def main():
     ...
     connection.set_option('enable_log', True)
