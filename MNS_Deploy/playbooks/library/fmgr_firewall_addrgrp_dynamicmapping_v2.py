...
DOCUMENTATION = '''
---
module: fmgr_firewall_addrgrp_dynamicmapping_v2
 ...
 - name: gathering fortimanager facts
   ...
   tasks:
    - name: retrieve all the dynamic mappings of IPv4 address group
      fmgr_fact:
        facts:
            selector: 'firewall_addrgrp_dynamicmapping_v2'
            params:
                adom: 'ansible'
...
def main():
    ...
    module = AnsibleModule(argument_spec=check_parameter_bypass(module_arg_spec, 'firewall_addrgrp_dynamicmapping_v2'),
